/* Longbox Native Page Turn — v59
 * First-party visual experiment. No external libraries.
 */
window.LongboxNativePageTurn = class {
  ...
  async turn(direction) {
    ...
    for (let i = 0; i < count; i++) {
      ...
      strip.className = "native-page-turn-strip";
    ...
    // Commit initial geometry before starting CSS animation.
